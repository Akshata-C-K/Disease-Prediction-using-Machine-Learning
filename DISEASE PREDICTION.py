...
df=pd.read_csv("C:\Prototype.csv")
...
tr=pd.read_csv("C:\Prototype-1.csv")
...
def DecisionTree():
    ...
    print('The Accuracy of decision tree classifier algorithm is : \n',accuracy_score(y_test, y_pred))
...
w2 = Label(root, justify=CENTER, text="Disease Prediction Using decision Tree",fg="black", bg="light blue", font=("Times", 30))
...
lrLb = Label(root, justify=LEFT, text="Disease", fg="white", bg="black")
lrLb.config(font=("Times", 18))
lrLb.grid(row=25, column=1, pady=20, sticky=W)
...
dst = Button(root, text="Prediction", command=DecisionTree, fg="black", bg="grey")
